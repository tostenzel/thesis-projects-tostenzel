...
def screening_measures(function, traj_list, step_list, cov, mu):
    ...
    fct_evals_original_piplusone_i = np.ones([n_rows, n_trajs]) * np.nan
    ...
    for traj in range(0, n_trajs):
        for row in range(0, n_rows):
            ...
            fct_evals_original_piplusone_i[row, traj] = function(
    ...
    for traj in range(0, n_trajs):
        ...
        ee_corr_i[:, traj] = (
            ...
            - fct_evals_original_piplusone_i[0:n_inputs, traj]
