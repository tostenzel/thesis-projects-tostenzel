...
\newpage
\begin{figure}[H]
	\caption{Sigma-normalized absolute mean Elementary Effects for trajectory design}
	\centering
	\includegraphics[scale=0.50]{../../../scrypy/figures/scatter_traj}
	\label{fig:traj}
\end{figure}

\begin{figure}[H]
	\caption{Sigma-normalized absolute mean Elementary Effects for radial design}
	\centering
	\includegraphics[scale=0.50]{../../../scrypy/figures/scatter_rad}
	\label{fig:rad}
\end{figure}
